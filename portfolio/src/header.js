...
const Header = () => {
  ...
  return (
    <section className="min-h-screen">
      <nav className="flex flex-wrap p-6 bg-neutral-800 justify-center items-center fixed w-full shadow-lg z-40">
        ...
        <div className="block lg:hidden">
          <button
            ...
            alt="navbar" aria-label="nav link"
          >
            <svg
        ...
        >
          <div className="nav">
            <a
              href="./CV_2023.pdf" target="_blank"
              className="block mt-4 lg:inline-block lg:mt-0   text-white px-4 py-2 rounded-md ml-8 mr-4"
              alt="mon cv en pdf"
            >
              Mon CV
            </a>
